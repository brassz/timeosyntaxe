...
const CHECKLIST_ITEMS = [
  { name: 'Pneus / Rodas / Esteiras', category: 'PNEUS-ESTEIRAS' },
  { name: 'Buzina', category: 'SINALIZAÇÃO' },
  { name: 'Luzes', category: 'SINALIZAÇÃO' },
  { name: 'Painel de alerta', category: 'SINALIZAÇÃO' },
  { name: 'Freio', category: 'DIVERSOS' },
  { name: 'Direção', category: 'DIVERSOS' },
  { name: 'Cabine em geral', category: 'DIVERSOS' },
  { name: 'Motor', category: 'DIVERSOS' },
  { name: 'Sistema hidráulico', category: 'DIVERSOS' },
  { name: 'Braços / Caçamba / Lâmina', category: 'DIVERSOS' },
  { name: 'Vazamentos visíveis', category: 'DIVERSOS' },
  { name: 'Condições externas gerais', category: 'DIVERSOS' },
  { name: 'Itens de segurança', category: 'SEGURANÇA' },
  { name: 'Extintor', category: 'SEGURANÇA' },
  { name: 'Documentação', category: 'SEGURANÇA' },
  { name: 'Nível de óleo', category: 'ÓLEOS' },
  { name: 'Nível de água', category: 'ÓLEOS' },
  { name: 'Filtros', category: 'ÓLEOS' },
];
